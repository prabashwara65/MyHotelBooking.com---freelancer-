<footer class="bg-black text-gray-400 px-6 py-12 mt-6">
  <div class="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
    ...
    <div>
      ...
      <ul class="space-y-2">
        <li><a href="tel:+123456789" class="hover:text-white transition-colors">+123 456 789</a></li>
        <li><a href="mailto:support@company.com" class="hover:text-white transition-colors">support@company.com</a></li>
        <li><span class="hover:text-white transition-colors">123 Street Name, City</span></li>
      </ul>
    </div>
